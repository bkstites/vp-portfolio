  ...
  return (
    <EMSLayout>
      <section className="w-full max-w-4xl mx-auto py-8 px-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6 border border-gray-200 dark:border-gray-700">
          <h3 className="text-2xl font-semibold mb-4 text-blue-700 dark:text-blue-300">Case Classification System</h3>
          <p className="mb-4 text-gray-800 dark:text-gray-200">
            The system automatically classifies patient narratives into specific medical case types and maps them to appropriate clinical protocols:
          </p>
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">Case Categories</h4>
              <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-1">
                <li>• <strong>Trauma:</strong> Motor vehicle accidents, falls, penetrating injuries</li>
                <li>• <strong>Medical-Cardiac:</strong> Chest pain, arrhythmias, cardiac arrest</li>
                <li>• <strong>Medical-Respiratory:</strong> Shortness of breath, respiratory distress</li>
                <li>• <strong>Medical-Neurological:</strong> Stroke, seizures, altered mental status</li>
                <li>• <strong>Obstetric:</strong> Labor, pregnancy complications</li>
                <li>• <strong>Pediatric:</strong> Pediatric-specific emergencies</li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">Protocol Integration</h4>
              <p className="text-sm text-gray-700 dark:text-gray-300">
                Each case type maps to specific New Jersey BLS protocols, providing targeted interventions, transport decisions, and priority assessments based on the classified case type.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-1">
                ...
                <li>• Aligned with NJ BLS protocols</li>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6 border border-gray-200 dark:border-gray-700">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-center">
            ...
            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
              ...
              <div className="text-sm text-gray-700 dark:text-gray-300">Case Classification Precision</div>
            </div>
            <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
              <div className="text-2xl font-bold text-purple-800 dark:text-purple-200">78%</div>
              <div className="text-sm text-gray-700 dark:text-gray-300">Narrative Analysis Sensitivity</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6 border border-gray-200 dark:border-gray-700">
          ...
          <div className="text-sm text-gray-700 dark:text-gray-300 space-y-2">
            ...
            <p><strong>NJ BLS Protocols:</strong> New Jersey Department of Health, Office of Emergency Medical Services. Basic Life Support Adult and Pediatric Treatment Protocols. 2023.</p>
          </div>
        </div>
